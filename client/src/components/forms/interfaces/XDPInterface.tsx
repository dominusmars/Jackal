...
const XDPInterface: React.FC<XDPInterfaceProps> = ({
    interface_,
    saveInterface,
    deleteInterface,
}) => {
    ...
    const handleChange = (
        ...
        setState((prevState) => {
            const newState = {
                ...prevState,
                [name as keyof SuricataXDPInterface]:
        ...
        <div className="flex justify-center items-center">
            <div className="flex flex-col gap-2 w-1/3">
                ...
                <div className="">
                    ...
                    <Select
                        id="force-bind-mode"
                        name="force-bind-mode"
                        value={state["force-bind-mode"] || ""}
                        onChange={handleChange}
                    >
                ...
                <div className="flex gap-3">
                    <Checkbox
                        id="mem-unaligned"
                        name="mem-unaligned"
                        checked={state["mem-unaligned"] || false}
                        onChange={handleChange}
                    />
                ...
                <div className="flex gap-3">
                    <Checkbox
                        id="enable-busy-poll"
                        name="enable-busy-poll"
                        checked={state["enable-busy-poll"] || false}
                        onChange={handleChange}
                    />
                ...
                <div className="">
                    <Label htmlFor="gro-flush-timeout">
                        GRO Flush Timeout:
                    </Label>
                    <TextInput
                        type="number"
                ...
                <div className="">
                    <Label htmlFor="napi-defer-hard-irq">
                        NAPI Defer Hard IRQ:
                    </Label>
                    <TextInput
                        type="number"
