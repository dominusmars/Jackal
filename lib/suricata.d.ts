export interface SuricataConfig {
    ...
    "engine-analysis": {
        "rules-fast-pattern": boolean;
        rules: boolean;
    };
    pcre: {
        "match-limit": number;
        "match-limit-recursion": number;
    };
    "host-os-policy": {
        windows: string[];
        bsd: string[];
    ...
    detect: {
        profile: string;
        "custom-values": {
            "toclient-groups": number;
            "toserver-groups": number;
        };
...
export interface SuricataDPDKInterface {
    ...
    promisc: boolean;
    multicast: boolean;
    "checksum-checks": boolean;
    "checksum-checks-offload": boolean;
    mtu: number;
    "mempool-size": number;
    "mempool-cache-size": number | "auto";
    "rx-descriptors": number;
    "tx-descriptors": number;
    "copy-mode": "none" | "tap" | "ips";
    "copy-iface": string;
}
