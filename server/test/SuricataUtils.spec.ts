import { makeSuricataRuleString, parseSuricataRule } from "../src/utils/suricataUtils";
...
describe("Suricata Utils", () => {
    ...
    it("should generate rule from suricataRule interface", () => {
        const rule: SuricataRule = {
            ...
            destination_port: "any",
            options: {
                msg: '"CVE-2006-2842: Squirrelmail <=1.4.6 - Local File Inclusion"',
                http_uri: true,
                nocase: true,
                content: '"/src/redirect.php"',
                classtype: "web-application-attack",
                sid: "22006001",
                rev: "1",
            },
        ...
        expect(ruleString).toEqual(
            `alert http any any -> any any (msg:"CVE-2006-2842: Squirrelmail <=1.4.6 - Local File Inclusion"; http_uri; nocase; content:"/src/redirect.php"; classtype:web-application-attack; sid:22006001; rev:1; metadata: from jackal;)`
        );
    });
});
